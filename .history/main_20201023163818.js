class Question{
    ...
    update() {
        if (this.Qanswer=="Yes"){
            $(`.mainChoice[rownum==${this.rowNum}]`).html("No")
        }else{
            $(`.mainChoice[rownum==${this.rowNum}]`).html("Yes")
        }
    }
...
function ProcessExcel(data) {
    ...
    var tableRow = $("<tr data-rownum=0  />1);
