 ...
 function ProcessExcel(data) {
     ...
     for (var i = 1; i < excelRows2.length; i++) {
         ...
         Object.keys(headerRow2).forEach(function (key) {
            ...
            var col = $(`<option val=${temp.Title.toLowerCase()} >${temp.Title} </option>`)
            currcol = 
            
            $("#selectProject").append(currcol)
 ...
 $(document).ready(function () {
     ...
     Submitbtn.on("click", function (e) {
         ...
         Object.keys(answersCollection).forEach(function (item) {

             answersCollection[item].update();
         })
