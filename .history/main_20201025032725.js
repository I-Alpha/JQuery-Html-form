 ...
 $(document).ready(function () {
     ...
     $("form").submit(function (e) {
        ...
        //  })
         ...
         var address =ur"https://prod-127.westus.logic.azure.com/workflows/20d1f86a228a4644a73ab3319bb3fbb8/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=8rjxYAFbO8C4iEqE_DM34gxYPOI_KjwDA7INnKxFmwQ"
         ...
         var rawdata = JSON.stringify(answersCollection)
           ...
           $.post(address, rawdata, alert("nice"),
             "json"
             ) ;
