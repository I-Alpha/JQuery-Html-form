  ...
  $(document).ready(function () {
      ...
      // SUBMIT  function 
        ...
        $('#submitbtn').on('click', function(event) {
          ...
          var address ="http://IbrahimAlfa@hotmail.co.uk"
          ...
          $.ajax({
              url: address,
              type: "POST",
              data:  <?php echo json_encode($my_var); ?>jsonpostdata,
              ...
              error: (function (jqHXR, exception) {
                  alert(`It seems there's an error. ${jqHXR.status} to be specific....Hmm.`);
