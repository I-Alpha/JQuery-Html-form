  ...
  $(document).ready(function () {
      ...
      $('#submitbtn').on('click', function (event) {
          ...
          var address = "ptsv2.com/t/6ag0v-1603880236/post"
          ...
          function ajaxCall(){
            ...
            }).then(function (jqh) {              confirm(jqh)
              if (jqh == 202 || jqh == 200) {
                  alert("Form has been completed successfully. Thanks!");
                  window.location.replace("htttp://www.google.com")
              } else {
            ...
            alert("There's been an error, please, try submitting again or contact the PWA Admins. errorcode = " + error)
            d.reject();
        });
