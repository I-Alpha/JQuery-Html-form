...
function checkSubmit() {
    ...
    var idate =$("input[type=date]")
            if (ifullname.val() == "" || itextarea.val() == " " || idate.val()==null) {
...
$(document).ready(function () {
    ...
    $("form").submit(function (e) {
        ...
        //post addresss    $("#testblock").html("<br/><br/>Before : "+ JSON.stringify(beforeTest[key])+"<br/><br/><br/>Sumbited :\n\n " +  JSON.stringify(answersCollection[key]))
