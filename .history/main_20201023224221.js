...
class Question{
    ...
    relRow.find(".mainCheck").is(":checked",function(e){
...
function ProcessExcel(data) {
    ...
    //create  instance of question class 
       ...
       //GET DATA FROM EXCEL ROW
        ...
        var tableRow = $(`<tr rowspan=2 data-qinfo="${currID}" data-rownum=${i} > </tr>`);
