...
//Read and process from ExcelSheet.xlsx. Must be in specific format : 2 sheets. All sheets first row must be headers. 1st sheet  must have headers "QID"  and "Standard" , to sig: 
