...
//Process in-line array questions  store in array in first section of this page
 ...
 //simple check if every visible text area has been filled out. if it is enable to the out 

 function checkSubmit(){


    if ($("textarea .vis]").val() == "" || $("textarea .vis").val() == " ") {
     ...
     $("form").submit(function (e) {
        ...
        //
         if ($("textarea .vis").val() == "" || $("textarea.vis").val() == " " || $("textarea.vis").val()== "" || ("textarea.vis").val() == " ") {
             confirm("Please complete provide additional information information in the textarea underneath questions!").done()
