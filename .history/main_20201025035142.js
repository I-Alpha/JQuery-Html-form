     ...
     $("form").submit(function (e) {
        ...
        var postData =[]; 
         Object.keys(answersCollection).some(function (key) {          
            ...
            postData.push(JSON.stringify{answersCollection[key]})var jsonString = JSON.stringify(foo, replacer);
            return key == 1; 
         });
         ...
         alert("Handler for .submit() called."); 
            ...
            $.post(address, JSON.stringify(postData) , 'json' ,'application/json');
