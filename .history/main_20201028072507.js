...
$(document).ready(function () {
    ...
    $("form").submit(function (e) {
        ...
        $.ajax({
           ...
           ,
            error: (function(jqHXR,exception){alert(`It seems there's an error. ${jq} Hmm. Email this JSON to this address.Thanks!"), download(JSON.stringify(postData), 'json.txt', 'text/plain')})
