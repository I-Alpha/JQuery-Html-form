...
function ProcessExcel(data) {
    ...
    for (var i = 1; i < excelRows.length; i++) {        
      ...
      var Qobject = new Question(); //GET DATA FROM EXCEL ROW
        ...
        answersCollection.i = Qobject; 
        var tableRow = $(`<tr rowspan=2 data-qinfo="${Qobject.id}" data-rownum=${i} > </tr>`);
