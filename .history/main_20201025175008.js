...
function toggleCheckState(text, elem) {
 ...
 $(document).ready(function () {
     ...
     $(".questCol span input").hide()

     $(".skipCheck").change(function(){
          
            if(this.is(":checked"))
        $(".questCol span input").show()
        else
        $(".questCol span input").hide()var Row =$(this).closest("tr")
        var skiptextElem =Row.find(".questCol span input")
        var rowID=Row.data(`rownum`);
